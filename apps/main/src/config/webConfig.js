...
export const CONFIG = {
  ...
  app: {
    name: "Locket hgh", // Tên app hiển thị
    author: "hgh",
    shortname: "locketdio",
    fullName: "Locket hgh - Đăng ảnh & Video lên Locket", // Tên đầy đủ
    ...
    contact: {
      supportEmail: "hegiahe@gmail.com",
    ...
    bankInfo: {
      ...
      urlImg: "https://cdn.locket-dio.com/v1/images/qr/hgh-mbbank-qr.jpg",
      bankName: "Ngân hàng TMCP Công thương Việt Nam",
      accountNumber: "999964715555",
      accountName: "DAO VAN DOI",
    },
    myInfo: {
      fullName: "Đào Văn Đôi (hgh)",
      email: "hegiahe@gmail.com",
      phone: "0123456789",
    ...
    videoTutorials: {
      ...
      iosAddscreen: {
        title: "Hướng dẫn thêm Locket hgh vào màn hình chính trên iPhone!",
        url: "https://www.youtube.com/embed/iElPAnQ7lNY",
      }, // Hướng dẫn thêm trang web vào màn hình chính trên iPhone (Safari)
      androidAddscreen: {
        title: "Hướng dẫn thêm Locket hgh vào màn hình chính trên Android!",
