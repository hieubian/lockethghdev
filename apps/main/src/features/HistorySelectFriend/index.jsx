  ...
  return ReactDOM.createPortal(
    ...
    >
      <div
        ...
        className={`overflow-hidden text-base-content w-full max-w-xs sm:max-w-sm max-h-[500px] mt-14 transition-all duration-500 ease-in-out transform origin-top
                  ${
                    isFriendHistoryOpen
          ...
          >
            <div className="flex items-center gap-3">
              <Avatar
                ...
                firstName={user?.firstName || "Bạn"}
                lastName={user?.lastName}
                className="w-10 h-10 border-[2.5px] p-0.5 border-base-300"
              ...
              >
                <div className="flex items-center gap-3">
                  <Avatar
                    ...
                    className="w-10 h-10 border-[2.5px] p-0.5 border-amber-400"
                    textClassName="text-md"
                  />
