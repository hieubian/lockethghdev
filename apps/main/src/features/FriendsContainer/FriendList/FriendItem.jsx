        ...
        <div className="flex items-center gap-1">
          ...
          {!isHidden && (
            ...
            >
              <button
                ...
                className="w-8 h-8 rounded-full flex items-center justify-center bg-[#00c3ff]/10 hover:bg-[#00c3ff]/20 text-[#00c3ff] transition-all duration-300"
              >
          ...
          >
            <button
              ...
              className="w-8 h-8 rounded-full flex items-center justify-center bg-base-200 hover:bg-base-300 text-base-content/70 transition-all duration-300"
            >
              {isHidden ? (
                <CircleEllipsis className="w-4 h-4" strokeWidth={2.5} />
              ) : (
                <X className="w-4 h-4 text-error" strokeWidth={2.5} />
              )}
            </button>
  ...
  return (
    <div className="relative w-16 h-16">
      <SharedAvatar
        ...
        className="w-16 h-16 border-[3.5px] p-0.5 border-[#00c3ff]"
      />
