  ...
  return (
    <div>
      ...
      <div className="flex gap-2 items-center mt-2">
        ...
        />
        <button
          className={`btn btn-sm md:btn-md bg-[#00c3ff] text-white border-none gap-2 rounded-full font-bold shadow-[0_4px_12px_rgba(0,195,255,0.2)] hover:bg-[#00c3ff]/90 hover:scale-105 active:scale-95 transition-all duration-300 ${
