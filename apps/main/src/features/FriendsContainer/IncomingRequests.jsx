      ...
      {friends.length === 0 && !loading && (
        <div className="flex justify-center my-4">
          <button
            ...
            className="bg-[#00c3ff] text-white hover:bg-[#00c3ff]/90 px-4 py-2 rounded-full font-semibold transition-all shadow-[0_4px_12px_rgba(0,195,255,0.25)] hover:scale-105 active:scale-95"
          >
              ...
              >
                <div className="flex items-center gap-3">
                  <img
                    ...
                    className="w-16 h-16 rounded-full border-[3.5px] p-0.5 border-[#00c3ff] object-cover"
                  />
                  <div>
                ...
                <button
                  className="btn flex items-center bg-[#00c3ff] hover:bg-[#00c3ff]/90 text-white px-3 py-1 rounded-full border-none shadow-[0_4px_12px_rgba(0,195,255,0.25)] transition-all"
                  onClick={(e) => {
                    e.stopPropagation();
