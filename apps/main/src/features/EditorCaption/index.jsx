...
const CaptionIconOverlay = ({
  ...
  return (
    <div
      className="flex items-center bg-white/50 backdrop-blur-2xl py-2 px-4 rounded-4xl gap-2"
      style={{
        width: `${width}px`,
    ...
    >
      ...
      <textarea
        ...
        rows={1}
        disabled={!isEditable}
        className="font-semibold outline-none flex-1 resize-none overflow-hidden transition-all bg-transparent"
        style={{
...
const LocationOverlay = ({
  ...
  return (
    <div
      className="flex items-center bg-white/50 backdrop-blur-2xl gap-1 py-2 px-4 rounded-4xl text-white font-semibold max-w-[90vw]"
      style={{ width: `${width}px` }}
    >
      <LocationIcon className="w-6 h-6 mr-0.5 flex-shrink-0" />
      <input
        ...
        placeholder={placeholder}
        className="font-semibold outline-none flex-1 bg-transparent truncate"
        style={{
          minWidth: "0",
        }}
      />
...
const EditorCaption = () => {
  ...
  const renderOverlay = () => {
    ...
    switch (overlayData.type) {
      ...
      case "review":
        return <ReviewOverlay payload={overlayData?.payload} overlayData={overlayData} />;
