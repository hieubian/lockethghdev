  ...
  return (
    ...
    >
      <div className="flex-1 flex flex-col justify-center items-center w-full gap-2 pb-25">
        <div className="relative w-full sm:max-w-sm max-w-[90vw] md:max-w-md aspect-square">

          <div
            className={`h-full w-full bg-base-200 rounded-[48px] md:rounded-[64px] overflow-hidden transition-all duration-300 ease-in-out ${
              isVisible && !isAnimating
